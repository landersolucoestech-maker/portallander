import { FileText, Globe2, Images, LayoutDashboard, Newspaper, Search, Settings, Tags } from 'lucide-react'
...
export function SiteCategories(){
  ...
  return <AdminShell area="cms" items={siteManagerNav}>
    ...
    <PersistenceNotice/>
    <div className="admin-toolbar"><div className="admin-toolbar-group"><div className="searchbox"><Search size={16}/><input placeholder="Buscar categoria..."/></div></div><span className="admin-breadcrumb">{categories.length} categorias encontradas</span></div>
...
export function SiteMedia(){
  ...
  return <AdminShell area="cms" items={siteManagerNav}>
    ...
    <PersistenceNotice/>
    <div className="admin-toolbar"><div className="admin-toolbar-group"><div className="searchbox"><Search size={16}/><input placeholder="Buscar mídia ou conteúdo..."/></div><button className="admin-filter" type="button">Todos os tipos</button></div><span className="admin-breadcrumb">{items.length} referências</span></div>
