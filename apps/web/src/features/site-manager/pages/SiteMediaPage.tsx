...
export function SiteMediaPage(){
  ...
  return <AdminShell area="cms" items={SITE_MANAGER_NAV} header={{title:'Mídia',description:'Inventário dos arquivos e referências de mídia já associados aos conteúdos editoriais.'}} headerAction={{label:'Adicionar mídia',disabled:true,disabledReason:ADMIN_CAPABILITIES.mediaStorage.description}}>
