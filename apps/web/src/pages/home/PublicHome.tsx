...
function PublicidadeLateralSection(){
  ...
  const media=imageUrl?<img className="pl-home-sidebar-ad-image" src={imageUrl} alt={legacy.imageAlt||'Publicidade'} style={{objectFit:configured.adImageFit}}/>:<img className="pl-home-sidebar-ad-image pl-home-sidebar-ad-fallback" src={portalLogo} alt="Portal Lander" style={{objectFit:'contain'}}/>
