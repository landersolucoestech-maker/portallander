...
export function HeaderManagerPage(){
  ...
  return <AdminShell area="cms" items={SITE_MANAGER_NAV} header={{title:'Cabeçalho',description:'Configuração do cabeçalho utilizado nas páginas do Portal Lander.'}} headerAction={{label:'Ver no site',icon:ExternalLink,variant:'secondary',onClick:openPublicSite}}>
    <HeaderBrandEditor/>
  </AdminShell>
}
