...
export default function FinanceAccountingPage(){
 ...
 return <AdminShell area="finance" items={CRM_WORKSPACE_NAV} header={{title:'Contabilidade',description:'Demonstrativos e visão contábil gerencial'}}>
  <section className="finance-page">
   ...
   <ResultTable title="P&L por Contrato" description="Resultado financeiro por contrato e operação" rows={contractRows} totalRevenue={rev}/>
   <ResultTable title="P&L por Cliente" description="Receitas, despesas e resultado por cliente" rows={clientRows} totalRevenue={rev}/>
  </section>
 </AdminShell>
}
