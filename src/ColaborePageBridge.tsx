...
export function ColaborePageBridge(){
  ...
  return <div className="public-page colabore-page">
    <PublicHeader/>
    <main>
      <section className="colabore-hero">
        <div className="public-shell colabore-hero-grid">
          ...
          <div className="colabore-hero-card">
            ...
            <div><b>01</b><span>Informação clara e verificável</span></div>
            <div><b>02</b><span>Material original ou com fonte identificada</span></div>
            <div><b>03</b><span>Contexto suficiente para análise editorial</span></div>
          </div>
        </div>
      </section>
