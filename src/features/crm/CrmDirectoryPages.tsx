...
function DemoNotice(){return <div className="admin-notice"><div><strong>Dados de demonstração</strong><p>Busca e filtros funcionam localmente sobre o snapshot demonstrativo. Criação, edição e exclusão continuam indisponíveis até existir backend real.</p></div></div>}
...
export function ContactsPage(){
  ...
  return <AdminShell area="crm" items={CRM_NAV}>
    <AdminPageHeader eyebrow="CRM / Contatos" title="Contatos" description="Pessoas e empresas relacionadas comercial ou institucionalmente ao portal." action="Novo contato" disabled/>
    <DemoNotice/>
...
export function DealsPage(){
  ...
  return <AdminShell area="crm" items={CRM_NAV}>
    <AdminPageHeader eyebrow="CRM / Negócios" title="Negócios" description="Oportunidades comerciais organizadas por etapa, responsável, valor e próximo passo." action="Novo negócio" disabled/>
    <DemoNotice/>
