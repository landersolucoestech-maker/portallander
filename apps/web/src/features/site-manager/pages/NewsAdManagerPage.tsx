...
export function NewsAdManagerPage(){
  return <AdminShell area="cms" items={SITE_MANAGER_NAV} header={{title:'Publicidade',description:'Gerencie a campanha publicitária lateral exibida na área de Notícias.'}}>
