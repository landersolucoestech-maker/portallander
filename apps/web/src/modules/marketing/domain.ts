...
export interface MarketingContent{id:string;title:string;context:string;subject:string;channels:string[];type:string;publishDate:string;publishTime:string;body:string;copy:string;campaign:string;hashtags:string[];location:string;status:ContentStatus;approval:ApprovalStatus;owner:string;creative?:CreativeConfig;createdAt:string;updatedAt:string}
