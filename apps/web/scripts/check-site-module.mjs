...
requireTokens('sectionConfiguration.ts',sectionModel,['HOME_SECTION_DEFINITIONS','EDITORIAL_PAGE_SECTION_DEFINITIONS','EDITORIAL_SECTION_DEFINITION','readSectionConfiguration','writeSectionConfiguration','resetSectionConfiguration',"id:'hero'","id:'em-destaque'","id:'mais-lidas'","id:'ultimas-noticias'","id:'publicidade-lateral'","id:'em-alta'","id:'anuncie-aqui'","id:'lancamentos'","id:'agenda'","id:'editorial-hero'","id:'editorial-template'","kind:'standard-hero'","kind:'editorial'","'em-destaque':{title:'EM DESTAQUE',linkLabel:'EXPLORAR DESTAQUES',linkUrl:'/noticias',itemLimit:3,columns:3}"])
...
const canonicalEditorPages=['SectionConfigurationPage.tsx','HomeContentSectionPage.tsx','HomeMostReadSectionPage.tsx','HomeAdvertisingSectionPage.tsx','HomeFeaturedSectionPage.tsx','GlobalHeroEditorPage.tsx']
...
console.log('Site module architecture OK — configuração de seções usa workbench e primitivas canônicas compartilhadas, sem regressão para editores legados')
