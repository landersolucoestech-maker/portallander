...
requireTokens('metricsClient.ts',client,['/api/metrics',"await import('@portallander/mockup')",'getMockupMetricsOverview'])
...
console.log('Metrics boundaries OK — módulo global, rota única, cinco abas internas, Marketing sem ownership e UI sem KPI de fixture.')
