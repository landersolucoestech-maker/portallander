...
export const siteFormRegistry:readonly SiteFormDefinition[]=[
  {
    ...
    consents:[
      {id:'lead-privacy',kind:'privacy',label:'Privacidade',required:true,version:'1.0',text:'Autorizo o tratamento dos dados informados para atendimento da minha solicitação.'},
    ],
  ...
  },
  {
    ...
    consents:[
      {id:'collab-rights',kind:'content_rights',label:'Autorização de compartilhamento',required:true,version:'1.0',text:'Confirmo que as informações são verdadeiras e que possuo autorização para compartilhar os materiais anexados quando necessário.'},
    ],
