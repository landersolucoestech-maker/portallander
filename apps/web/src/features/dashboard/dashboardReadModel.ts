...
export const dashboardReadModel={
 snapshot(now=new Date()){
  ...
  return {period:{month:currentMonth,generatedAt:nowIso},monthRevenue,receivable,activeContracts:activeContracts.length,pendingCommercialPublications,pipeline,revenueByCategory,upcoming,alerts:operational.alerts,editorialCounts}
 },
}
