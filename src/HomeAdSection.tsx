...
export function HomeAdSection({ config }: { config?: HomeAdConfig }) {
  const [runtime, setRuntime] = useState<HomeAdConfig>(() => config || readHomeAdConfig())
