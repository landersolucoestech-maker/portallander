...
import {handleContentIngestionRequest} from './contentIngestionHttp.js'
...
import {handleMarketingRequest} from './marketingHttp.js'
...
const server=createServer((req,res)=>{
  void (async()=>{
    ...
    if(await handleContentIngestionRequest(req,res))return
    ...
    if(await handleMarketingRequest(req,res))return
