...
import { applyArticleToSlide, defaultHeroConfig, defaultHeroSlide, heroArticles, readHeroConfig, resetHeroConfig, writeHeroConfig, type HeroCarouselConfig, type HeroSlide } from '../models/heroModel'
  ...
  return <div className="hero-editor">
    ...
    <div className="hero-editor-layout">
      <section className="panel hero-editor-form">
        ...
        <Field label="Texto sobre a imagem / assinatura editorial" hint="Exibido sobre a área direita do Hero. Pode ser alterado ou deixado vazio para ocultar."><input value={slide.mediaCaption} onChange={e=>updateSlide({mediaCaption:e.target.value})}/></Field>
