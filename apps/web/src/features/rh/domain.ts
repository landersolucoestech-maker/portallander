...
export interface RhSeed{employees:Employee[];payroll:PayrollEntry[];leaves:LeaveEntry[];documents:EmployeeDocument[];departments:string[];documentTypes:string[];leaveTypes:string[];runtime?:{documentUpload?:{configured:boolean}};meta?:{version:number;updatedAt:string}}
