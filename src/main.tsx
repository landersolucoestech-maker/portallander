...
import { HeaderBrandBridge } from './shared/branding/HeaderBrandBridge'
import { BrandAssetsBridge } from './shared/branding/BrandAssetsBridge'
import { NewsPageBridge } from './pages/noticias/NewsPageBridge'
import { NewsAdBridge } from './pages/noticias/NewsAdBridge'
import { ArticlePageBridge } from './pages/article/ArticlePageBridge'
import { ClickableCardsBridge } from './shared/behaviors/ClickableCardsBridge'
