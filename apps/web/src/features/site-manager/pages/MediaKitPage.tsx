...
export function MediaKitPage(){
  ...
  return <AdminShell area="cms" items={SITE_MANAGER_NAV}>
    <AdminPageHeader eyebrow="Gerenciador do Site / Mídia Kit" title="Mídia Kit" description="Estrutura administrativa para materiais comerciais, audiência e apresentação institucional." action="Editar mídia kit" disabled disabledReason={ADMIN_CAPABILITIES.editorialPersistence.description}/>
