...
export function ColaborePage(){
  ...
  const submit=async({payload,acceptedConsentIds,files,antiSpam}:SiteFormSubmitPayload)=>{
    ...
    await submitSiteForm(activeForm.slug,{payload,acceptedConsentIds,files,antiSpam,source:{entryContext:'colabore',page:window.location.pathname,referrer:document.referrer||undefined}})
