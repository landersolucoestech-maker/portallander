...
export function AboutPage({page}:{page:EditorialPage}){
  ...
  const hero=useSectionConfiguration(page.id,'about-hero','Hero Institucional')
  ...
  return <PageShell className="about-page sobre-page institutional-page" newsletterConfiguration={newsletter}>
