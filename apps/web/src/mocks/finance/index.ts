...
export const mockFinanceTransactions:FinanceTransaction[]=Array.from({length:72},(_,index)=>{
 ...
 const categoryPair=type==='receita'?receiptCategories[index%receiptCategories.length]:expenseCategories[index%expenseCategories.length]
