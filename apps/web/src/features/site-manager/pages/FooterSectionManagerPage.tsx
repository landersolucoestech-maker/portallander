...
export function FooterSectionManagerPage(){
  ...
  return <AdminShell area="cms" items={SITE_MANAGER_NAV} header={{title:'Configurar seção: Rodapé',description:'Configuração isolada do Rodapé oficial da Homepage.',backTo:'/app/site/secoes',backLabel:'Seções das Páginas'}} headerAction={{label:'Ver no site',icon:ExternalLink,variant:'secondary',onClick:openPublicSite}}>
    <div className="section-editor-layout grid-editor-layout">
      ...
      <section className="section-editor-preview-column grid-editor-preview">
        <div className="section-editor-card section-preview-card">
          <div className="section-preview-toolbar"><div><h2>Prévia do Rodapé</h2><p>Somente a configuração preservada do Rodapé permanece neste módulo.</p></div></div>
