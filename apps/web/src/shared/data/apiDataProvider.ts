...
export type ApiDataSnapshot={
 ...
 agenda:{items:ReturnType<ApplicationDataProvider['agenda']['items']>;events:ReturnType<ApplicationDataProvider['agenda']['events']>;participants:ReturnType<ApplicationDataProvider['agenda']['participants']>;locations:ReturnType<ApplicationDataProvider['agenda']['locations']>}
...
export function createApiDataProvider(snapshot:ApiDataSnapshot):ApplicationDataProvider{
 return {
  ...
  agenda:{items:()=>clone(snapshot.agenda.items),events:()=>clone(snapshot.agenda.events),participants:()=>clone(snapshot.agenda.participants),locations:()=>clone(snapshot.agenda.locations)},
