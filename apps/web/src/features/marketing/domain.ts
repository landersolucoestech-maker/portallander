...
export interface MarketingCampaign{id:string;name:string;description:string;context:string;platforms:string[];status:CampaignStatus;budget:number;spend:number;clicks:number;impressions:number;conversions:number;startDate:string;endDate:string;owner:string;notes:string;createdAt:string;updatedAt:string}
export interface MarketingContent{id:string;title:string;context:string;artist:string;channels:string[];type:string;publishDate:string;publishTime:string;copy:string;campaign:string;hashtags:string;location:string;status:ContentStatus;approval:ApprovalStatus;owner:string;createdAt:string;updatedAt:string}
...
export interface MarketingBriefing{id:string;title:string;type:string;objective:string;context:string;audience:string;positioning:string;tone:string;owners:string[];deadline:string;deliverables:string[];channels:string[];status:BriefingStatus;references:string;createdAt:string;updatedAt:string}
