...
const requiredFiles=[
  'src/modules/site-manager/pageRepository.ts','src/modules/site-manager/contentDraftRepository.ts','src/modules/site-manager/mediaRepository.ts','src/modules/site-manager/mediaKitRepository.ts','src/modules/site-manager/mediaKitDomain.ts','src/modules/site-manager/sectionConfiguration.ts','src/modules/site-manager/useSectionConfiguration.ts','src/modules/site-manager/usePublicHomeSections.ts','src/modules/site-manager/components/SiteMediaPicker.tsx','src/modules/site-manager/components/SectionEditorUi.tsx','src/modules/site-manager/forms/draftRepository.ts','src/modules/site-manager/forms/SiteFormRenderer.tsx','src/modules/site-manager/forms/runtimeOptions.ts','src/modules/site-manager/pages/SiteSectionsPage.tsx','src/modules/site-manager/pages/SectionConfigurationPage.tsx','src/modules/site-manager/pages/HomeReleasesSectionPage.tsx','src/modules/site-manager/spotifyReleaseClient.ts','src/modules/site-manager/pages/SiteContentEditorPage.tsx','src/modules/site-manager/pages/SiteFormEditorPage.tsx','src/modules/site-manager/pages/SiteFormsPage.tsx','src/modules/site-manager/pages/SiteMediaPage.tsx','src/modules/site-manager/pages/MediaKitPage.tsx','src/modules/editorial/adminClient.ts','src/modules/editorial/components/EditorialListingPage.tsx','src/modules/editorial/components/EditorialContentPage.tsx','src/modules/editorial/components/StructuredPublicPage.tsx','src/app/publicSpecialPageRegistry.tsx','src/app/PublicSpecialPageRenderers.tsx','src/pages/home/components/SpotifyReleasesSection.tsx','src/pages/home/styles/spotify-releases.css','src/pages/about/AboutPage.tsx','src/pages/collaborate/CollaboratePage.tsx','src/pages/contact/ContactPage.tsx','src/shared/public/PublicPageArchitecture.tsx','src/shared/public/PublicEditorialModules.tsx','src/styles/public-page-architecture.css','src/styles/section-editor-workbench.css','src/styles/spotify-releases-editor.css',
]
...
const sharedEditorUi=await read('src/modules/site-manager/components/SectionEditorUi.tsx')
...
for(const file of canonicalEditorPages){
  const source=await read(`src/modules/site-manager/pages/${file}`)
...
const releasesEditor=await read('src/modules/site-manager/pages/HomeReleasesSectionPage.tsx')
...
const contentDomain=await read('src/modules/site-manager/homeContentSectionConfiguration.ts')
...
const listingTemplate=await read('src/modules/editorial/components/EditorialListingPage.tsx')
...
const contentTemplate=await read('src/modules/editorial/components/EditorialContentPage.tsx')
...
const structuredPage=await read('src/modules/editorial/components/StructuredPublicPage.tsx')
...
requireTokens('publicSpecialPageRegistry.tsx',specialRegistry,['SPECIAL_LAYOUT_PAGE_SLUGS','sobre:page=><AboutPage page={page}/>','colabore:page=><CollaboratePage page={page}/>','contato:page=><ContactPage page={page}/>'])
const specialRenderers=await read('src/app/PublicSpecialPageRenderers.tsx')
requireTokens('PublicSpecialPageRenderers.tsx',specialRenderers,['../pages/about/AboutPage','../pages/collaborate/CollaboratePage','../pages/contact/ContactPage','LazyAboutPage','LazyCollaboratePage','LazyContactPage'])

const formRenderer=await read('src/modules/site-manager/forms/SiteFormRenderer.tsx')
...
const formEditor=await read('src/modules/site-manager/pages/SiteFormEditorPage.tsx')
...
const collaborate=await read('src/pages/collaborate/CollaboratePage.tsx')
requireTokens('CollaboratePage.tsx',collaborate,['SiteFormRenderer','resolveSiteFormOptionSets','submitSiteForm','mode="public"','<PageShell','<PageHero'])
const formDraftRepository=await read('src/modules/site-manager/forms/draftRepository.ts')
requireTokens('forms/draftRepository.ts',formDraftRepository,["status:'draft'","source:'custom'"])
const forms=await read('src/modules/site-manager/pages/SiteFormsPage.tsx')
...
const contents=await read('src/modules/site-manager/pages/SiteContentsPage.tsx')
...
const contentEditor=await read('src/modules/site-manager/pages/SiteContentEditorPage.tsx')
...
const mediaPicker=await read('src/modules/site-manager/components/SiteMediaPicker.tsx')
...
const contentDraftRepository=await read('src/modules/site-manager/contentDraftRepository.ts')
requireTokens('contentDraftRepository.ts',contentDraftRepository,["status:'draft'",'active:false','noIndex:true'])
const editorialAdminClient=await read('src/modules/editorial/adminClient.ts')
...
const media=await read('src/modules/site-manager/pages/SiteMediaPage.tsx')
...
const mediaRepository=await read('src/modules/site-manager/mediaRepository.ts')
...
const readModel=await read('src/modules/site-manager/readModel.ts')
requireTokens('readModel.ts',readModel,['getRuntimeDataProvider().editorial.media()'])

const mediaKit=await read('src/modules/site-manager/pages/MediaKitPage.tsx')
...
const mediaKitRepository=await read('src/modules/site-manager/mediaKitRepository.ts')
...
const editorialModel=await read('src/modules/editorial/model.ts')
