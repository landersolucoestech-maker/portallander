...
const sections=[
  ...
  {name:'Anúncio principal',state:'Local no navegador',editable:true,description:'Bloco publicitário principal renderizado diretamente pela Home pública.',to:'/app/site/home/anuncio',countLabel:'Editor local'},
